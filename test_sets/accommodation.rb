requires 'test_sets/sb_s_contact_defaults.rb'
requires 'test_sets/sb_s_case_defaults.rb'
requires 'test_sets/sb_s_case_xm_defaults.rb'
requires 'test_sets/accommodation_defaults.rb'
requires 'test_sets/clnt_case_srvc_typ_defaults.rb'
...
# test case 2, null value end date
...
# test case 3, case status not active or finalised
...
# test case 4, case not type client case
...
# test case 5, Accomodation care not active or finalised
...
# test case 6, CSR not accom care
...
# test case 7, CSR not type Service
...
# test case 8, No detention managed by record
...
# test case 9, attrib_34 not null
...
# test case 10, run_sk on client case triggers load
...
# test case 11, run_sk on dmb triggers load
...
# test case 12, no run_sk change, no records loaded
all_tables :ACIT_BUS_RULES => 'ODS.ACCOMMODATION_11'
...
# test case 14, IBMSNAP not set to D
